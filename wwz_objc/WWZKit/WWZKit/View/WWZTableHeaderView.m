...
@implementation WWZTableHeaderView
/**
 *  为只读属性生成成员变量
 */
...
+ (instancetype)wwz_headerViewWithTabelView:(UITableView *)tableView{
    ...
    WWZTableHeaderView *headerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:reuseIdentifier];
    if (!headerView) {
