...
//
	...
	#define WWZKEYCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
	// Keychain access group available at compile time
	#define WWZKEYCHAIN_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef WWZKEYCHAIN_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, WWZKeychainQuerySynchronizationMode) {
	WWZKeychainQuerySynchronizationModeAny,
	WWZKeychainQuerySynchronizationModeNo,
	WWZKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface WWZKeychainQuery : NSObject
...
@property (nonatomic) WWZKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 WWZKEYCHAIN_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
