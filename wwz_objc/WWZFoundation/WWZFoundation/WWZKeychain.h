...
/**
 Error code specific to WWZKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, WWZKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	WWZKeychainErrorBadArguments = -1001,
};

/** WWZKeychain error domain */
extern NSString *const kWWZKeychainErrorDomain;

/** Account name. */
extern NSString *const kWWZKeychainAccountKey;
 ...
 */
extern NSString *const kWWZKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kWWZKeychainClassKey;

/** Item description. */
extern NSString *const kWWZKeychainDescriptionKey;

/** Item label. */
extern NSString *const kWWZKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kWWZKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kWWZKeychainWhereKey;
...
/**
 ...
 WWZKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface WWZKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in WWZKeychain.h for a list of keys that can be used when accessing the
